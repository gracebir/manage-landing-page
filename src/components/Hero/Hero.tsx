...
function Hero() {
  return (
    <div className='absolute top-40 right-0 left-0 lg:pt-10 flex flex-col-reverse items-center gap-4 px-6 lg:container lg:px-0 lg:mx-auto lg:flex-row lg:justify-between'>
        <div className='flex flex-col items-center gap-4 text-center lg:text-start lg:items-start lg:w-[33rem]'>
            ...
            <a href="#getstarted" className='bg-bgBright text-clLightGray font-bold px-8 py-3 rounded-full shadow-2xl mt-6'>Get Started</a>
        </div>
