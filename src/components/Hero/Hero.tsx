...
function Hero() {
  return (
    <div className='lg:pt-10 flex flex-col-reverse items-center gap-4 px-6 lg:container lg:px-0 lg:mx-auto lg:flex-row lg:justify-between'>
      {/* <div className='lg:bg-bgHero lg:bg-no-repeat lg:bg-right-top'></div> */}
