...
function About() {
  return (
    <div className='py-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:container lg:mx-auto lg:py-36'>
      <div className='flex flex-col gap-6 col-span-1 lg:gap-8 items-center lg:items-start px-8'>
